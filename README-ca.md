...
La fluïdesa en la línia de comandes és una habilitat sovint descuidada o considerada arcana, però millora la teva flexibilitat i productivitat com a enginyer tant de manera òbvia com subtil. Aquesta és una selecció de notes i consells sobre l'ús de la línia d'ordres que hem trobat útil quan treballem en Linux. Algunes consells són elementals, i alguns són força específics, sofisticats o obscurs. Aquesta pàgina no és llarga, però si pots utilitzar i recordar tots els elements aquí, en saps molt.

Aquest treball és el resultat de molts autors i traductors [many authors and translators](AUTHORS.md).
Alguns d'aquests
...
[**Please submit a question**](https://airtable.com/shrzMhx00YiIVAWJg) si teniu una pregunta relacionada amb la línia d'ordres. [**Please contribute**](/CONTRIBUTING.md) si veus un error o quelcom que es podria millorar!
